...
const Home = () => {
    ...
    return (
       ...
       <span className='absolute   z-10'>
        ...
        <h1 className='backdrop-blur-sm shadow-lg  px-12 py-3 rounded-full text-xl text-white font-Poppins'>The Best Free Stock Photos Royalty Free    <i class="fad fa-cat-space"></i></h1>
       </span>
