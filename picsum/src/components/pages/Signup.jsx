...
const googleCliendId = process.env.REACT_APP_GOOGLE_OAUTH_API_KEY;
...
formData.append('password', data.password);  
   ...
   axios.post('http://localhost/api/signup.php',formData,config).then((result)=>{ 
       ...
       <>
        <div className='flex '>
            ...
            <form autoComplete='off' className='flex flex-col' onSubmit={handleSubmit}>
                    ...
                    <input type='password' name='password' placeholder='Create Password' className='w-[25rem] mt-2.5 bg-[#efefef] outline-none py-3 px-4 rounded-full font-Poppins 
